...
file_path = r"D:\HealthCare_ChatBot\fhir-rag-cpg\data\influenza_guideline.txt"
...
Use the following text from clinical guideline to answer the question.
...
# 6. Ask questions
queries = [
    "When should Oseltamivir be prescribed?",
    "What is the recommended duration for severe influenza?",
